...
const moleculeArt = {
  ...
  tetrabromo: `<svg viewBox="0 0 190 190"><g class="sticks"><path d="M95 38 139 64 139 116 95 142 51 116 51 64Z"/><path d="M95 38V10M139 64l26-15M139 116l22 13M95 142v28M51 116l-26 15M51 64 29 51"/></g><g class="carbons"><circle cx="95" cy="38" r="8"/><circle cx="139" cy="64" r="8"/><circle cx="139" cy="116" r="8"/><circle cx="95" cy="142" r="8"/><circle cx="51" cy="116" r="8"/><circle cx="51" cy="64" r="8"/></g><g class="bromines"><circle cx="95" cy="10" r="13"/><circle cx="165" cy="49" r="13"/><circle cx="95" cy="170" r="13"/><circle cx="25" cy="131" r="13"/></g><g class="hydrogens"><circle class="hydrogen" cx="165" cy="131" r="6"/><circle class="hydrogen" cx="25" cy="49" r="6"/></g></svg>`
};
